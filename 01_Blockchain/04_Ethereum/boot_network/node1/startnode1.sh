...
geth --identity "geth_node1" \
--networkid 2104 \
--datadir "$Account_dir" \
--bootnodes "enode://5d2ee718fadf5ee82e64034b1e01eaf6116de3bf8ed20aef4bed2b9cbc2031be80111f9421cf607ae633eab20237196a26de697a55d826381962ffbab757071b@127.0.0.1:30301" \
--syncmode full \
--gcmode archive \
--http --http.port "8042" \
--port "30303" \
