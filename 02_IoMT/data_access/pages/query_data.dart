...
class _QueryDataPageState extends State<QueryData> {
  ...
  void initState() {
    ...
    _controller_startTime.text='2025-02-10';
    _controller_endTime.text='2025-02-10';
  }
  ...
  void _updateText() {
    // print(_controller_startTime.text);
    // print(_controller_endTime.text);

    // Call async function to retrive data from aws API gateway
    futureSteps = getSteps(_controller_startTime.text,_controller_endTime.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(
      //   title: const Text('Search Activity-Steps'),
      // ),
              ...
              width: 360, 
                child: Padding( 
                  ...
                  child: ElevatedButton( 
                    child: Text( 'Query Steps', style: TextStyle(color: const Color.fromARGB(255, 3, 59, 105), fontSize: 20), 
                    ), 
